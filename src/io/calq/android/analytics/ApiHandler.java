...
public class ApiHandler extends Handler {
	 ...
	 */
	protected void onNewApiCallReceived(AbstractAnalyticsApiCall apiCall) {
	...
	public void handleMessage(Message msg) {
		switch(msg.what) {
			...
			case MESSAGE_API:
				onNewApiCallReceived((AbstractAnalyticsApiCall) msg.obj);
				break;
	...
	/**
	 * Message type for sending API messages.
	 */
	public static final int MESSAGE_API = 1;
